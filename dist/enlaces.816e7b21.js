...
Scroller.prototype.scrollAnimate = function() {
    if (this.scrollTop() > 0 && this.stop == false) setTimeout((function() {
        this.scrollAnimate();
...
Scroller.prototype.checkPosition = function() {
    window.addEventListener("scroll", (function(e) {
        if (this.scrollTop() > this.options.showButtonAfter) this.show();
        else this.hide();
    }).bind(this), false);
};
Scroller.prototype.stopListener = function() {
    ...
    window.addEventListener("scroll", (function(e) {
        if (this.scrollTop() > position) this.stopTimeout(200);
